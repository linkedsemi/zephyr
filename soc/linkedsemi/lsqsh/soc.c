...
#endif
        iopmp_config_region_napot4(dev, 2, 0x10060000, KB(128), true, true, true, false);
...
#endif
#if DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(peci1))
    APP_PMU->PECI_PAD_CFG.PD_PU |= 0x1 << 16;
    APP_PMU->PECI_PAD_CFG.DS_IEN &= ~(0x1);
#endif
#if DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(peci2))
