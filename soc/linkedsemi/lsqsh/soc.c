...
static void peripheral_init()
{
    ...
    MODIFY_REG(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_TX_DIV_MASK, 0); /* div = 2 */
    MODIFY_REG(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_TX_SEL_MASK, 0x2); /* rxck pad */
    SET_BIT(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_TX_CG_MASK);

    MODIFY_REG(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_RX_DIV_MASK, 0); /* div = 2 */
    MODIFY_REG(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_RX_SEL_MASK, 0x2); /* rxck pad */
    SET_BIT(SYSC_APP_AWO->ETH1_CLK_CFG, SYSC_APP_AWO_ETH1_CLK_RX_CG_MASK);

    MODIFY_REG(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_TX_DIV_MASK, 0);
    MODIFY_REG(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_TX_SEL_MASK, 0x2); /* rxck pad */
    SET_BIT(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_TX_CG_MASK);
    MODIFY_REG(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_RX_DIV_MASK, 0); /* div = 2 */
    MODIFY_REG(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_RX_SEL_MASK, 0x2); /* rxck pad */
    SET_BIT(SYSC_APP_AWO->ETH2_CLK_CFG, SYSC_APP_AWO_ETH2_CLK_RX_CG_MASK);
    /* SYSC_APP_AWO->ETH1_CLK_CFG */


    /* SYSC_APP_AWO->EMMC1_TX_RX_CLK */
    MODIFY_REG(SYSC_APP_AWO->EMMC1_TX_RX_CLK, SYSC_APP_AWO_EMMC1_CLK_TX_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->EMMC1_TX_RX_CLK, SYSC_APP_AWO_EMMC1_CLK_RX_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->EMMC1_CORE_TIM_CLK, SYSC_APP_AWO_EMMC1_CLK_CORE_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->EMMC1_CORE_TIM_CLK, SYSC_APP_AWO_EMMC1_CLK_TIM_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_CPU->ETH1_PHY_CTRL, SYSC_APP_CPU_ETH1_PHY_INTF_SEL_MASK, 0x1); /* rgmii */
    MODIFY_REG(SYSC_APP_CPU->ETH1_PHY_CTRL, SYSC_APP_CPU_ETH1_PHY_SEL_MASK, 0x1); /* rgmii */
    /* SYSC_APP_CPU->ETH1_PHY_CTRL */


    /* SYSC_APP_AWO->EMMC2_TX_RX_CLK */
    MODIFY_REG(SYSC_APP_AWO->EMMC2_TX_RX_CLK, SYSC_APP_AWO_EMMC2_CLK_TX_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->EMMC2_TX_RX_CLK, SYSC_APP_AWO_EMMC2_CLK_RX_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->EMMC2_CORE_TIM_CLK, SYSC_APP_AWO_EMMC2_CLK_CORE_DIV_MASK, 0);
    MODIFY_REG(SYSC_APP_AWO->EMMC2_CORE_TIM_CLK, SYSC_APP_AWO_EMMC2_CLK_CORE_SEL_MASK, 0x4); /* dpll 200M */
    SET_BIT(SYSC_APP_AWO->EMMC2_CORE_TIM_CLK, SYSC_APP_AWO_EMMC2_CLK_CORE_CG_MASK);

    MODIFY_REG(SYSC_APP_AWO->EMMC2_CORE_TIM_CLK, SYSC_APP_AWO_EMMC2_CLK_TIM_DIV_MASK, 0);
    ...
    MODIFY_REG(SYSC_APP_AWO->LPC_CLK, SYSC_APP_AWO_LPC1_CLK_DIV_MASK, 0x0);
    ...
    MODIFY_REG(SYSC_APP_AWO->LPC_CLK, SYSC_APP_AWO_LPC2_CLK_DIV_MASK, 0x0);
