...
IF_ENABLED(CONFIG_DCACHE, (BUILD_ASSERT(IS_ENABLED(CONFIG_DCACHE_LINE_SIZE_DETECT) ||
...
static void peripheral_init()
{
    ...
    REG_FIELD_WR(SYSC_APP_AWO->PD_AWO_CLK_CTRL1, SYSC_APP_AWO_CLK_SEL_I3C, 0x1);
    /*
    i3c clock
        clk_pbus4: 0x4 , 75Mhz
        dpll: 0x2 , 50Mhz
