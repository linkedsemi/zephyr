...
#error please set CONFIG_COMMON_LIBC_MALLOC=n
#endif

#ifdef CONFIG_COMMON_LIBC_MALLOC_LSQSH
...
#   define HEAP_2_SIZE	ROUND_UP(CONFIG_COMMON_LIBC_MALLOC_ARENA_2_SIZE, HEAP_ALIGN)
