...
// static bool peci_device_i3c_check(char* peci_device)
// {
...
//     if (strncmp(peci_device, "/dev/peci-default", DEV_NAME_SIZE) == 0)
//     {
//         // Check if peci-default points to peci-i3c
//         char peci_link[DEV_NAME_SIZE] = {0};
//         ssize_t length;

//         length = readlink("/dev/peci-default", peci_link,
//                           sizeof(peci_link) - 1);
//         if (length != -1)
//         {
//             // peci_link needs to be null-terminated
//             peci_link[length] = '\0';

//             if (strncmp(peci_link, "/dev/peci-i3c", DEV_NAME_SIZE) == 0)
//             {
//                 return true;
//             }
//         }
