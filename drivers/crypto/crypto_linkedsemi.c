                                           ...
                                           enum cipher_op op_type)
{
    ...
    if (op_type == CRYPTO_CIPHER_OP_ENCRYPT) {
        ...
        case CRYPTO_CIPHER_MODE_CTR:
            ...
            break;
        case CRYPTO_CIPHER_MODE_CCM:
            ctx->ops.ccm_crypt_hndlr = crypto_linkedsemi_ccm_encrypt_auth;
            break;
        case CRYPTO_CIPHER_MODE_GCM:
        ...
        case CRYPTO_CIPHER_MODE_CTR:
            ...
            break;
        case CRYPTO_CIPHER_MODE_CCM:
            ctx->ops.ccm_crypt_hndlr = crypto_linkedsemi_ccm_decrypt_auth;
            break;
        case CRYPTO_CIPHER_MODE_GCM:
...
static int crypto_linkedsemi_query_caps(const struct device *dev)
{
    ...
    return CRYPTO_LINKEDSEMI_CIPHER_CAPS;
}
