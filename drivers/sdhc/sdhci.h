...
// int sdhci_wait_command_done(struct sdhci_host *sdhci_host, struct sdhci_command *command, bool execute_tuning);
// int sdhci_transfer_data_blocking(struct sdhci_host *sdhci_host, struct sdhci_data *data, bool use_dma);
...
// int sdhci_transfer_blocking(struct sdhci_host *sdhci_host);
void sdhci_init(struct sdhci_host *host);
// void sdhci_irq(int vector, void *param);
