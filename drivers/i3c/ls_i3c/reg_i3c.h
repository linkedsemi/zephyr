...
typedef struct
{
    ...
    volatile uint32_t SCONFIG;                           /**< offset: 0x4 Slave Configuration Register,  */
    volatile uint32_t SSTATUS;                           /**< offset: 0x8 Slave Status Register,  */
    volatile uint32_t SCTRL;                             /**< offset: 0xC Slave Control Register,  */
    volatile uint32_t SINTSET;                           /**< offset: 0x10 Slave Interrupt Set Register,  */
    volatile uint32_t SINTCLR;                           /**< offset: 0x14 Slave Interrupt Clear Register,  */
    volatile uint32_t SINTMASKED;                        /**< offset: 0x18 Slave Interrupt Mask Register,  */
    volatile uint32_t SERRWARN;                          /**< offset: 0x1C Slave Errors and Warnings Register,  */
    volatile uint32_t SDMACTRL;                          /**< offset: 0x20 Slave DMA Control Register,  */
    volatile uint32_t RESERVED_1[2];
    volatile uint32_t SDATACTRL;                         /**< offset: 0x2C Slave Data Control Register,  */
    volatile uint32_t SWDATAB;                           /**< offset: 0x30 Slave Write Data Byte Register,  */
    volatile uint32_t SWDATABE;                          /**< offset: 0x34 Slave Write Data Byte End,  */
    volatile uint32_t SWDATAH;                           /**< offset: 0x38 Slave Write Data Half-word Register,  */
    volatile uint32_t SWDATAHE;                          /**< offset: 0x3C Slave Write Data Half-word End Register,  */
    volatile uint32_t SRDATAB;                           /**< offset: 0x40 Slave Read Data Byte Register,  */
    volatile uint32_t RESERVED_2[1];
    volatile uint32_t SRDATAH;                           /**< offset: 0x48 Slave Read Data Half-word Register,  */
    ...
    volatile uint32_t SCAPABILITIES;                     /**< offset: 0x60 Slave Capabilities Register,  */
    volatile uint32_t SDYNADDR;                          /**< offset: 0x64 Slave Dynamic Address Register,  */
    volatile uint32_t SMAXLIMITS;                        /**< offset: 0x68 Slave Maximum Limits Register,  */
    volatile uint32_t SIDPARTNO;                         /**< offset: 0x6C Slave ID Part Number Register,  */
    volatile uint32_t SIDEXT;                            /**< offset: 0x70 Slave ID Extension Register,  */
    volatile uint32_t SVENDORID;                         /**< offset: 0x74 Slave Vendor ID Register,  */
    volatile uint32_t STCCLOCK;                          /**< offset: 0x78 Slave Time Control Clock Register,  */
    volatile uint32_t SMSGMAPADDR;                       /**< offset: 0x7CSlave Message-Mapped Address Register,  */
...
{
    I3C_SCONFIG2_CCRCCC_EN_MASK = (int)0x2,
    I3C_SCONFIG2_CCRCCC_EN_POS = 1,
...
enum I3C_REG_SSTATUS_FIELD
{
    ...
    I3C_SSTATUS_NOWCNTLR_MASK = (int)0x400000,
    I3C_SSTATUS_NOWCNTLR_POS = 22,
...
{
    I3C_SINTSET_NOWCNTLR_MASK = (int)0x400000,
    I3C_SINTSET_NOWCNTLR_POS = 22,
...
{
    I3C_SINTCLR_NOWCNTLR_MASK = (int)0x400000,
    I3C_SINTCLR_NOWCNTLR_POS = 22,
...
{
    // 从机的I3C part number id，如果需要应用配置。
